...
printf "\n  Run ${BOLD}tideftp${NC} to open, then press ${BOLD}c${NC} to connect —\n"
printf "  or ${DIM}tideftp --host files.example.com --user you --path /srv/www${NC}\n\n"
