...
const defaultReleasesURL = "https://api.github.com/repos/allisonhere/TideFTP/releases/latest"
const binaryName = "tideftp"
...
const SuggestedManualInstallScript = "curl -fsSL https://raw.githubusercontent.com/allisonhere/TideFTP/main/install.sh | sh"
...
func (u *Updater) assetName() (string, error) {
	...
	switch goos {
	case "linux", "darwin":
		return binaryName + "-" + goos + "-" + arch, nil
	default:
