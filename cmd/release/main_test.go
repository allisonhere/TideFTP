...
func TestGitHubSlug(t *testing.T) {
	for remote, want := range map[string]string{
		"git@github.com:allisonhere/TideFTP.git":       "allisonhere/TideFTP",
		"https://github.com/allisonhere/TideFTP.git":   "allisonhere/TideFTP",
		"ssh://git@github.com/allisonhere/TideFTP.git": "allisonhere/TideFTP",
		"https://example.com/allisonhere/TideFTP.git":  "",
	} {
